...
for param in bert_embedder.bert_model.encoder.layer[9:].parameters():
...
optimizer = optim.SGD([{'params': model.text_field_embedder.token_embedder_tokens.bert_model.encoder.layer[11].parameters(), 'lr': 0.001},
                        ...
                        {'params': model.text_field_embedder.token_embedder_tokens.bert_model.encoder.layer[9].parameters(), 'lr': 0.0009025}
                        ], lr=0.001)
# Default
